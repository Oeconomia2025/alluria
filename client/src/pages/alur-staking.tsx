                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex space-x-2">
                        {[25, 50, 75, 100].map((percentage) => (
                          <Button key={percentage} variant="outline" size="sm" onClick={() => handleAlurStakePercentageClick(percentage)}
...
export default function AlurStaking() {
  return <AlurStakingContent />;
}
